...
$.fn.easySlider = function(o) {
    ...
    return this.each(function() {                           // Returns the element collection. Chainable.
        ...
        if (o.mainImg)
			changeMainImage($("a", li.eq(active)).attr('href'), $("a", li.eq(active)).attr('rel'));
		...
		function changeMainImage(thumbUrl, $originUrl){
			$(o.mainImg).attr('src', thumbUrl);
			$(o.mainImg).attr('data-zoom-image', $originUrl);
			$('.zoomWindow').css('background-image', 'url('+$originUrl+')');
		}
