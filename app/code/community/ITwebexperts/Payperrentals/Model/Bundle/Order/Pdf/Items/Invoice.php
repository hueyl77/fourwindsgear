 ...
 */
class ITwebexperts_Payperrentals_Model_Bundle_Order_Pdf_Items_Invoice extends Mage_Bundle_Model_Sales_Order_Pdf_Items_Abstract
{
	/**
	 * Draw item line
	 *
	...
	public function draw()
	{
		...
		if ($options) {
			...
			if(isset($options['info_buyRequest'])) {
                ...
                if($order->getIsSingle() == 1){
                    $lines[][] = array(
                        'text'  => Mage::helper('core/string')->str_split('(reservation)', 35, true, true),
                        'feed'  => 35
                    );
                }
			}
