 ...
 */
class ITwebexperts_Payperrentals_Helper_Catalog_Product_Configuration extends Mage_Catalog_Helper_Product_Configuration
{
     ...
     * @return array
     */
    protected function _getOptions(Mage_Catalog_Model_Product_Configuration_Item_Interface $item){

        $product = $item->getProduct();
        return Mage::helper('payperrentals/rendercart')->renderDates(null, $item, $product, true);
        //return renderdates
    }
