...
class ITwebexperts_Payperrentals_Block_Adminhtml_Catalog_Product_Edit_Tab_Payperrentals_Reservationprices extends Mage_Adminhtml_Block_Widget implements Varien_Data_Form_Element_Renderer_Interface
{
    protected $_customerGroups;

    public function __construct()
    {
        $this->setTemplate('payperrentals/product/edit/tab/payperrentals/reservationprices.phtml');
    }
        ...
        $this->setChild('add_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick' => 'reservationPricesControl.addItem()',
                    'class' => 'add'
                )));
    ...
    public function makeDateTimeBlock($name, $val)
    {
        ...
        $element = $this->getLayout()->createBlock('core/html_date')
            ...
            ->setId('reservationprices_row_{{index}}_' . $val)
    ...
    {
        $collectionPrices = Mage::getModel('payperrentals/reservationprices')->getCollection()
            ->addEntityStoreFilter($this->getProduct()->getId(), $this->getProduct()->getStoreId())
            ->getItems();
