 ...
 */
class ITwebexperts_Payperrentals_Block_Adminhtml_Sales_Order_Return_Create extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     *
     */
	...
	{
		$header = Mage::helper('payperrentals')->__('New Return for Order #%s', $this->getOrder()->getRealOrderId());
		return $header;
	}
