 ...
 */
class ITwebexperts_Payperrentals_Block_Adminhtml_Sales_Order_Deposit
    ...
    {
        return Mage::helper('payperrentals')->__('Deposit');
    }
    ...
    public function getItemsCollection(){
		if(!$this->_collection){
			...
			$order = $this->getOrder();
			$this->_collection = Mage::getModel('payperrentals/sales_payment_transaction')->getCollection()->addFieldToFilter('order_id', array('eq' => $order->getId()))->addPaymentInformation(array('method'))->load();
		}
