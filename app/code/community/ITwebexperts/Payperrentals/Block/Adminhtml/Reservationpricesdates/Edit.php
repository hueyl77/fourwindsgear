<?php
class ITwebexperts_Payperrentals_Block_Adminhtml_Reservationpricesdates_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText(){
        return Mage::helper('payperrentals')->__('Editing Price By Date');
    }
}