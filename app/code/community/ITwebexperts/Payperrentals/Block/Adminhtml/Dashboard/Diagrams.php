...
class ITwebexperts_Payperrentals_Block_Adminhtml_Dashboard_Diagrams extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    {
        $this->addTab('calendar', array(
            'label'     => $this->__('Calendar'),
            'content'   => $this->getLayout()->createBlock('ITwebexperts_Payperrentals_Block_Adminhtml_Dashboard_Tab_Calendar')->toHtml(),
            'active'    => true
        ));
