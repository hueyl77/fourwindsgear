...
/**
 * Class ITwebexperts_Payperrentals_Block_Adminhtml_Html_Rendererqueue_Senddate
 */
class ITwebexperts_Payperrentals_Block_Adminhtml_Html_Rendererqueue_Senddate extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    /**
