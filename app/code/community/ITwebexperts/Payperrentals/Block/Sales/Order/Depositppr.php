 ...
 */
class ITwebexperts_Payperrentals_Block_Sales_Order_Depositppr extends Mage_Checkout_Block_Total_Default
{
	/**
	 * Custom template
	 *
	 * @var string
	 */
	protected $_template = 'payperrentals/total/depositppr.phtml';
    /**
