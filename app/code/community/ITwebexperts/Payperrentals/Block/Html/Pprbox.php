 ...
 */
class ITwebexperts_Payperrentals_Block_Html_Pprbox extends Mage_Core_Block_Template
{
    ...
    public function getAttrValues(){
        ...
        $attributes = Mage::getResourceModel('eav/entity_attribute_collection')
            ...
            ->addFieldToFilter('attribute_code', Mage::getStoreConfig('payperrentals/calendar_widget/attrib_name',Mage::app()->getStore()));
        $attribute = $attributes->getFirstItem()->setEntity($product->getResource());
        return $attribute->getSource()->getAllOptions(false);
    }

    public function getMainCategory($catId){
        return Mage::getModel('catalog/category')->load($catId);
    }

    public function getFrontendCategories(){
        $catString		=	Mage::getStoreConfig('payperrentals/calendar_widget/cat_names',Mage::app()->getStore());
