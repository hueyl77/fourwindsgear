...
if(class_exists('GetSomeMojo_Bundledmojo_Block_Catalog_Product_View_Type_Bundle_Option_Select')){
    class ITwebexperts_Payperrentals_Block_Bundle_Catalog_Product_View_Type_Bundle_Option_Select
        extends ITwebexperts_Payperrentals_Block_Bundle_Catalog_Product_View_Type_Bundle_Option
    {
        /**
         * Product Type
         */
        const PROD_TYPE = GetSomeMojo_Bundledmojo_Helper_Data::XML_MOJO_TYPE_SELECT;
        ...
        public function __construct()
        {
            ...
            ->setYeaH4select($this->getMojoHelper()->getSystemConfigValue(self::PROD_TYPE, GetSomeMojo_Bundledmojo_Helper_Data::XML_MOJO_TYPE_ENABLE, $this->getCurrentStore()));

        if ($this->getYeaH4yeaH() && $this->getYeaH4select()) {
                $this->setTemplate('payperrentals/catalog/product/view/type/bundle/option/mojo' . self::PROD_TYPE . '.phtml');
            } else {
                $this->setTemplate('payperrentals/catalog/product/view/type/bundle/option/select.phtml');
            }
