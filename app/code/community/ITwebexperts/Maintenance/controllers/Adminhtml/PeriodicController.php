<?php
class ITwebexperts_Maintenance_Adminhtml_PeriodicController extends Mage_Adminhtml_Controller_Action
{
    protected function _isAllowed(){
        return Mage::getSingleton('admin/session')->isAllowed('admin/payperrentals/maintenance/periodic');
    }
    ...
    public function editAction()
    {
        ...
        $tableItem = Mage::getModel('simaintenance/periodic');
    ...
    public function saveAction()
    {
        if($this->getRequest()->getPost())
        {
            try {
                ...
                if($data){
                    $tableItem = Mage::getModel('simaintenance/periodic')->load($id);
    ...
    public function deleteAction(){
        $id = $this->getRequest()->getParam('id');
        if($id !=0 || $id != null){
            Mage::getModel('simaintenance/periodic')->load($id)->delete();
