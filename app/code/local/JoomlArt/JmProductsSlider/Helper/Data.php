    ...
    public function get($var, $attributes, $storeCode = null, $websiteCode = null)
    {
        ...
        if(isset($attributes[$var])){
            ...
            if ($storeCode){
                ...
                $configGroups = Mage::app()->getWebsite($websiteCode)->getConfig('joomlart_jmproductsslider');
            }else{
                $configGroups = Mage::getStoreConfig("joomlart_jmproductsslider",$this->defaultStoreCode);
            }
