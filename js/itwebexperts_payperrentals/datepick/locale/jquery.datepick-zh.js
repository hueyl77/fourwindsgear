...
(function($jppr) {
	$jppr.datepick.regional['zh-CN'] = {
		...
		renderer: $jppr.extend({}, $jppr.datepick.defaultRenderer,
			{month: $jppr.datepick.defaultRenderer.month.
	...
	$jppr.datepick.setDefaults($jppr.datepick.regional['zh-CN']);
})(jQuery);
