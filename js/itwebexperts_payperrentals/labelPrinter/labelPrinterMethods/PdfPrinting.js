var PdfPrinting = function (LabelPrinter) {
	...
	this.loadPageOne = function (isBack){
		var PageOne = jQuery('<table width="100%" cellspacing="20">' +
			'<tbody>' +
			'<tr>' +
			(jQuery.inArray('8160-b', LabelPrinter.option('labelTypes')) > -1 ? '<td data-label_type="8160-b" align="center" class="ui-corner-all" style="border:2px solid white;"><img src="' + Image8160 + '"><br>Avery 5160/8160<br>( For: Barcode )</td>' : '') +
			(jQuery.inArray('8160-s', LabelPrinter.option('labelTypes')) > -1 ? '<td data-label_type="8160-s" align="center" class="ui-corner-all" style="border:2px solid white;"><img src="' + Image8160 + '"><br>Avery 5160/8160<br>( For: Shipping )</td>' : '') +
			(jQuery.inArray('8164', LabelPrinter.option('labelTypes')) > -1 ? '<td data-label_type="8164" align="center" class="ui-corner-all" style="border:2px solid white;"><img src="' + Image8164 + '"><br>Avery 5164/8164<br>( For: Product Info )</td>' : '') +
			'</tr>' +
			'</tbody>' +
			'</table>');
		...
		PageOne.find('td').each(function () {
			jQuery(this)
				...
				.click(function () {
					...
					LabelPrinter.setUserData('labelType', jQuery(this).data('label_type'));
	...
	this.loadPageTwo = function (isBack){
		...
		jQuery.each(selectedSpecs.options, function (optionText, oInfo) {
			var optionHtml = '';
			if (oInfo.inputType == 'radio'){
				jQuery.each(oInfo.data, function (k, v) {
