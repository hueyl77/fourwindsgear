				...
				if (this.settings[extensionName]) {
					...
					if (typeof oursettings !== 'function') {
						...
						oursettings = function(){
                            $laststroke = Translator.translate('Undo Last Stroke');
							// this === jSignatureInstance 
							var undoButtonSytle = 'position:relative;display:none;margin:0 !important;top:auto'
							, $undoButton = $('<input type="button" value="' + $laststroke +'" style="'+undoButtonSytle+'" />')
